...
if(isset($_POST['btnSave']) && $_POST['routineName']!="")
{
    ...
    {
        $fileName = "Edu_Calendar" . "." . time() . "." .$control->getExtension($_FILES['routineFile']['name']);
    ...
    $saveEducationCalendarData=$control->saveEducationCalendarData($routineData);

    if($saveEducationCalendarData)
    {
...
<form action="" method="post" enctype="multipart/form-data">
    <article class="module width_full">
        <header>
            <h3 class="tabs_involved">New Education Calendar</h3>
