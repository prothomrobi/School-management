...
if(isset($_POST['btnSave']) && $_POST['routineName']!="")
{
    ...
    {
        $fileName = "Exam_Routine" . "." . time() . "." .$control->getExtension($_FILES['routineFile']['name']);
    ...
    $saveExamRoutineData=$control->saveExamRoutineData($routineData);

    if($saveExamRoutineData)
    {
...
<form action="" method="post" enctype="multipart/form-data">
    <article class="module width_full">
        <header>
            <h3 class="tabs_involved">New Exam Routine</h3>
