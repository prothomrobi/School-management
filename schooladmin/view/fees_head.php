...
if(isset($_POST['btnSave']) && $_POST['headName']!="")
{
    $feesHead=array($_POST['headName'],$_SESSION['asbUser'],date('Y-m-d'));
    $saveFeesHead=$control->saveFeesHead($feesHead);
