...
if(isset($_POST['btnSave']) && $_POST['routineName']!="")
{
  ...
  {
      $fileName = "Files" . "." . time() . "." .$control->getExtension($_FILES['routineFile']['name']);
  ...
  else
  {
   ...
   $saveClassRoutineData=$control->saveRoutineData($routineData);

    if($saveClassRoutineData)
    {
...
<form action="" method="post" enctype="multipart/form-data">
    <article class="module width_full">
        <header>
            <h3 class="tabs_involved">New Class Routine</h3>
