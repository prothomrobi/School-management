...
$allStudentList=$control->allStudentList();
...
<article class="module width_full">
    <header><h3 class="tabs_involved">Student List</h3> <label style="text-align: right;">Class Wise: <select name="promoTo" id="classData" onchange="classStudentList(this.value)"><option>Select</option><?php foreach($allClass as $cl): ?> <option value="<?php echo $cl[0]; ?>"><?php echo $cl[1]; ?></option> <?php endforeach; ?><option>Archive</option></select></label></header>
    ...
    <div class="tab_container">
        <div id="tab1" class="tab_content">
            <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tbody>
                <?php foreach($allStudentList as $asl): ?>
                    <tr align="center">
