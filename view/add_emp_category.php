     <div class="widget-header">
        <h3>Add Employee Category</h3> <a href="?l=arh&page=hr_setting" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
            <!-- /widget-header -->
...
<form method="post" class="form-horizontal">
                <fieldset>
                  ...
                  <div class="control-group">
                  <div class="col-md-3">
                    <label for="normal-field" class="control-label">Prefix</label>
                    </div>
                    <div class="col-md-7">
                    <div class="form-group">
                      <input type="text" placeholder="Prefix" class="form-control input-transparent" id="transparent-field">
                    </div>
                    </div>
                  </div>
                  <div class="control-group">
...
<table align="left" cellpadding="0" cellspacing="0" border="0" class="table table-striped">
      ...
      <tbody>
        <tr class="gradeX">
          ...
          <td class="center"><a href="?l=arh&page=edit_emp_category" class="btn btn-sm btn-primary"> Edit </a></td>
