        <div class="widget-header">
          <h3>Fees Stucture</h3> <a href="?l=arh&page=fees" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
       <!--  
...
<table align="left" cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="example">
      <thead>
        <tr align="left">
          ...
          <th width="40"><strong>First Name</strong></th>
          <th width="30%"><strong>Batch</strong></th>
