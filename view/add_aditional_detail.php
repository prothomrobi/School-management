     <div class="widget-header">
        <h3>Add Additional Detail</h3> <a href="?l=arh&page=hr_setting" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
            <!-- /widget-header -->
...
<table align="left" cellpadding="0" cellspacing="0" border="0" class="table table-striped">
      <thead>
        <tr>
          <th width="90"><strong>Active Fields</strong></th>
          <th width="5%"></th>
          <th width="5%"></th>
          </tr>
        </thead>
      <tbody>
        <tr class="gradeX">
          ...
          <td class="center"><a href="?l=arh&page=edit_additional" class="btn btn-sm btn-primary"> Edit </a></td>
