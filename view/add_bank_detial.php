     <div class="widget-header">
        <h3>Add Bank Detail</h3> <a href="?l=arh&page=hr_setting" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
            <!-- /widget-header -->
...
<table align="left" cellpadding="0" cellspacing="0" border="0" class="table table-striped">
      <thead>
        <tr>
          <th width="90"><strong>Active Bank</strong></th>
          <th width="5%"></th>
          <th width="5%"></th>
          </tr>
        </thead>
      <tbody>
        <tr class="gradeX">
          ...
          <td class="center"><a href="?l=arh&page=edit_bank" class="btn btn-sm btn-primary"> Edit </a></td>
     ...
     <thead>
        <tr>
          <th width="90"><h4>Inactive Bank</h4></th>
          <th width="5%"></th>
          <th width="5%"></th>
          </tr>
        </thead>
