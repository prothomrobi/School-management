     <div class="widget-header">
        <h3>Add Employee Department</h3> <a href="?l=arh&page=hr_setting" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
            <!-- /widget-header -->
...
<form method="post" class="form-horizontal">
                <fieldset>
                  ...
                  <div class="control-group">
                  <div class="col-md-3">
                    <label for="normal-field" class="control-label">Department Code</label>
                    </div>
                    <div class="col-md-7">
                    <div class="form-group">
                        <select class="form-control input-transparent" id="transparent-field">
                      <option>sdfsadf</option>
                      <option>asdf</option>
