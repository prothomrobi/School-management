        <div class="widget-header">
          <h3>Send SMS to Student</h3><a href="?l=arh&page=sms_setting" style="float:right; padding:12px;"><h5>BACK</h5></a>
        </div>
            <!-- /widget-header -->
...
<form method="post" >
     <fieldset>
		...
		<div class="control-group">
             <div class="col-md-3">
             <label for="normal-field" class="control-label">Select A Batch:</label>
             </div>
             <div class="col-md-7">
