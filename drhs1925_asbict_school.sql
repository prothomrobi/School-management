...
--
-- Host: localhost:3306
-- Generation Time: May 03, 2017 at 06:01 AM
...
CREATE TABLE `tbl_bright_student_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_class_course_info` (
  `id` int(15) NOT NULL,
...
CREATE TABLE `tbl_class_routine_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_designation_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_education_calendar_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_employee_attendance_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_employee_category_info` (
  `id` int(15) NOT NULL,
...
CREATE TABLE `tbl_exam_routine_info` (
  `id` int(12) NOT NULL,
  `exam_name` varchar(85) NOT NULL,
...
CREATE TABLE `tbl_fees_head_info` (
  `id` int(15) NOT NULL,
...
CREATE TABLE `tbl_gallery_image_info` (
  `id` int(15) NOT NULL,
...
(8, 'image-8', 'studentimages/Gallery.1439835096.jpg', 'asbict', '2015-08-18'),
...
CREATE TABLE `tbl_head_teacher_info` (
  `id` int(12) NOT NULL,
...
INSERT INTO `tbl_head_teacher_info` (`id`, `teacher_name`, `teacher_details`, `teacher_image`, `insert_by`, `insert_date`) VALUES
(1, 'নুর আহম্মদ মজুমদার', '', '', 'asbict', '2015-12-02'),
(2, 'নুরুল হক (ভারপ্রাপ্ত)', '', '', 'asbict', '2015-12-02'),
(3, 'মোঃ আক্তারুজ্জামান', '', '', 'asbict', '2015-12-02'),
(4, 'মাওঃ ইসমাইল হোসেন', '', '', 'asbict', '2015-12-02'),
(5, 'নুর আহম্মদ মজুমদার', '', '', 'asbict', '2015-12-02'),
(6, 'আহম্মদ উল্যা', '', '', 'asbict', '2015-12-02'),
(7, 'মোতালেব হোসেন মজুমদার', '', '', 'asbict', '2015-12-02'),
(8, 'মোঃ শফিকুল ইসলাম', '', '', 'asbict', '2015-12-02'),
(9, 'মোঃ সিরাজুল হক ', '২৩/৯/১৯৭৭ ইং – ২১/৭/১৯৯৩ ইং', '', 'asbict', '2015-12-02'),
(10, 'মোঃ ইলিয়াস ভূঁইয়া ', '২২/৭/১৯৯৩ ইং – ৪/৭/২০১১ ইং', '', 'asbict', '2015-12-02'),
(12, 'মোঃ নুরুল হক (ভারপ্রাপ্ত) ', '১৬/৮/২০১১ ইং – ৩/৩/২০১২ ইং', '', 'asbict', '2015-12-02'),
(13, 'মোঃ তসলিম মিয়া ', '৪/৩/২০১২ ইং – বর্তমান পর্যন্ত', 'employeeimages/teacher_.1449054408.jpg', 'asbict', '2015-12-02');
...
CREATE TABLE `tbl_holiday_calendar_info` (
  `id` int(12) NOT NULL,
...
(8, 'ম্যানেজিং কমিটি নিরবাচন-২০১৫  [৫ অকটোবর রোজ সোমবার সকাল ১০ ঘটিকা ', 'আগামী ৫ অকটোবর রোজ সোমবার সকাল ১০ ঘটিকা হইতে বিকাল ৪ ঘটিকা পরযনত বিদ্যালয়ের ম্যানেজিং কমিটি নিরবাচন অনুষিঠত হবে। সকল অভিভাবক ভোটারকে উকত সময়ে বিদ্যালয়ে এসে ভোট দেওয়ার জন্য অনুরোধ করা গেল।', 'drhs1925', '2015-09-27');
...
CREATE TABLE `tbl_public_result_info` (
  `id` int(12) NOT NULL,
  `exam_name` varchar(85) NOT NULL,
...
CREATE TABLE `tbl_result_sheet_info` (
  `id` int(12) NOT NULL,
...
CREATE TABLE `tbl_student_archive_info` (
  `id` int(12) NOT NULL,
...
(952, '6001A', 'Nusrat Jebin Afsana     ', 'Md. Abul Kalam Azad     ', 'Rowsan Ara Azad    ', '', 56, 'Female', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01715690900  ', '', '1970-01-01', 'studentimages/Thumbnail.1469506418.jpg', 'asbict', '2016-07-26'),
(953, '6002A', 'Tanvir Alam             ', 'Delwar Hossain          ', 'Khodeja Akhter       ', '', 56, 'Male', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01751828659 ', '', '1970-01-01', 'studentimages/Thumbnail.1469506465.jpg', 'asbict', '2016-07-26'),
(954, '6003A', 'Faria Helali Trisha         ', 'Faruk Helali          ', 'Noyon Begum         ', '', 59, 'Female', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01715174055', '', '1970-01-01', 'studentimages/Thumbnail.1469506513.jpg', 'asbict', '2016-07-26'),
...
(1300, '7001C', 'Rasel Hossain         ', 'Jashim Uddin         ', 'Halima Begum   ', '', 54, 'Male', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '', '', '1970-01-01', 'studentimages/Thumbnail.1472365847.jpg', 'asbict', '2016-08-28'),
(1301, '7002C', 'Sumaiya Akhter           ', 'Delwar Hossain            ', 'Shohagi Begum     ', '', 54, 'Female', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01881525925', '', '1970-01-01', 'studentimages/Thumbnail.1472365888.jpg', 'asbict', '2016-08-28'),
...
(1535, '9001H', 'Shahinur Akhter         ', 'Shafi Ullah       ', 'Nasima Akhter       ', '', 49, 'Female', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01705598240', '', '1970-01-01', 'studentimages/Thumbnail.1472447174.jpg', 'asbict', '2016-08-29'),
...
(1695, '10001B', 'Md. Mahbub Karim        ', 'Md. Rezaul Karim         ', 'Laili Rabeya      ', '', 45, 'Male', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01761769375', '', '1970-01-01', 'studentimages/Thumbnail.1472532349.jpg', 'asbict', '2016-08-30'),
...
(1728, '100045B', 'Jahid Hossain        ', 'Amjad Hossain         ', 'Rahima Begum      ', '', 45, 'Male', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01787542662', '', '1970-01-01', 'studentimages/Thumbnail.1472533967.jpg', 'asbict', '2016-08-30'),
(1729, '100047B', 'Shahida Akhter      ', 'Abul Kalam     ', 'Jahanara Begum            ', '', 45, 'Female', 'Bangladesh', 'Islam', 'Dolta, Ramgonj, Lakhsmipur.', '01704475496', '', '1970-01-01', 'studentimages/Thumbnail.1472534008.jpg', 'asbict', '2016-08-30');
...
CREATE TABLE `tbl_teacher_assign_course_info` (
  `id` int(12) NOT NULL,
  `class_id` int(15) NOT NULL,
  `course_id` int(15) NOT NULL,
...
(1, 'Currently there is no vacancy.', 'Currently there is no vacancy.', '', 'asbict', '2015-06-30');
...
--
ALTER TABLE `tbl_student_info`
  MODIFY `id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1730;
--
